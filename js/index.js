...
function Quote() {
    if (shownQuote.length === arr.length) {
        shownQuote = [];
    }
    var ran;
    do(
    ...
    while (shownQuote.includes(ran));

    shownQuote.push(ran)

    document.getElementById("quote").innerHTML=arr[ran].quote
    document.getElementById("author").innerHTML=arr[ran].author
